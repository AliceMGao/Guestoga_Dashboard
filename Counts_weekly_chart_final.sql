...
This_wk.counts  AS 'Total Patients',
Last_wk.counts as 'Total last week'
From (select
...
SUM SQLOUT.SQLOUT.Total_Patients AS 'Current Week'
SQLOUT.SQLOUT.Total_last_week AS 'Previous Week'
BY SQLOUT.SQLOUT.Dates NOPRINT
BY SQLOUT.SQLOUT.Name_of_Day_of_Week
HEADING
"Patient Count by Weekday"
...
setTextString(getY1Title(),"Count of Patients");
*GRAPH_JS_FINAL
"xaxis": {
    "title": {
